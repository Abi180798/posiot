   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <br/>
            <br/>
                <a class="btn btn-success btn-md" href="<?php echo base_url().'welcome'?>">Menu Utama</a>
            </div>
            <hr/>
        </div>
        <!-- /.row -->
                  ...
                  <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                    ...
                    ?>
                        <tr>
                            ...
                            <form action="<?php echo base_url().'admin/penjualan/add_to_cart'?>" method="post">
                            <input  name="kode_brg" value="<?php echo $id?>">
                            <input  name="nabar" value="<?php echo $nm;?>">
                            <input name="satuan" value="<?php echo $satuan;?>">
                            <input  name="stok" value="<?php echo $stok;?>">
                            <input name="harjul" value="<?php echo number_format($harjul);?>">
